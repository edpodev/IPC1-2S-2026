...
Acá está la idea que explica el comportamiento que van a ver más adelante, sobre todo en `07-arreglos/README.md`:
...
El siguiente diagrama dibuja exactamente este escenario con un `int` y un arreglo lado a lado — vale la pena proyectarlo antes de seguir.

![Comparación entre una variable primitiva copiada por valor en el stack y un arreglo copiado por referencia en el heap](../assets/stack-heap-valor-referencia.svg)
